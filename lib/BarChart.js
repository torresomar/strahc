...
var BarChart = React.createClass({
    ...
    render: function(){
        ...
        return (
            <div className='strahc-component' id={this.props.id}>
    ...
    _initChart: function(){
        ...
        var chart = this;
        var setupFns = [chart.setupSize(), chart.setupXAxis(), chart.setupYAxis(), chart._setupDomains()];
        var renderFns = [chart.renderXAxis(), chart.renderYAxis(), chart._renderBars(), chart.renderYGrid(), chart.renderTooltip(), chart.renderYBreaks()];
        // Run setup functions
    ...
    _updateChart: function(){
        ...
        .append('rect')
        .call(this._rect);
        console.log(d3.selectAll('g.bars-group'));
    },
    ...
    _rect: function(rect){
        ...
        .attr('y', function(d){
            return chart._y(Math.max(0, d[valueFn]));
        })
